module Text.Megaparsec.AsParse
  ...
  I.failure, I.label, I.hidden, I.try, I.lookAhead, I.notFollowedBy, I.eof, I.token, I.tokens, I.getParserState, I.updateParserState, I.StorableStream(I.fromFile), I.Stream(I.uncons)
