...
-- opt_execCompletion :: CompletionResult -> String -> IO String
opt_execCompletion = I.execCompletion

type OptParserFailure a = I.ParserFailure a
-- opt_execFailure :: forall h. ParserFailure h -> String -> (h, ExitCode, Int)
opt_execFailure = I.execFailure
